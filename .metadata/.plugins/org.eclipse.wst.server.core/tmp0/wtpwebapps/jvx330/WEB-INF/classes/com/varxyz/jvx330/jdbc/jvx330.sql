...
CREATE TABLE Customer(
	...
	ssn	    VARCHAR(14)		NOT NULL,   -- 123456-7890125
	phone   VARCHAR(20)		NOT NULL,   -- 010-1234-0125-
...
CREATE TABLE Account(
	...
	CONSTRAINT Account_cusmerId_FK
		FOREIGN KEY(customerId) REFERENCES Customer(cid)
)AUTO_INCREMENT = 3001;

SELECT * FROM Account;

ALTER TABLE Account change accountNum  accountNum CHAR(11) NOT NULL;
