...
<div class="container add_ac">
  <div class="success">
    ...
    <p>${name}님의 계좌는 다음과 같습니다.</p>
    <div class="accountListBox">
		<c:forEach var="text" items="${accountList}"><br>
			${text}
		</c:forEach>
    </div>
	<button type="button" class="add_acb v_acc" onclick='location.href="<c:url value='/main'/>"'>메인으로</button>
	</div>
	</div>
